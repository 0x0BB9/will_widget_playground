...
class StepperExamplesPage extends StatefulWidget {
  const StepperExamplesPage({super.key});

  @override
  State<StepperExamplesPage> createState() => _StepperExamplesPageState();
}

class _StepperExamplesPageState extends State<StepperExamplesPage> {
  int _currentStep = 0;
  final steps = [
    '第一步：账户验证',
    '第二步：个人信息',
      ...
      (i) => Steps(
        ...
        leading: Container(
          ...
          decoration: BoxDecoration(
            color: i < 2 ? Colors.amber : Colors.blue,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("步骤合集")),
      body: SafeArea(
        child: ListView(
          padding: EdgeInsets.all(20),
          children: [
            _buildExampleSection("基础步骤"),
            buildNormalStepper(),
            SizedBox(
              height: 400,
              child: FlutterSteps(
                ...
                titleFontSize: 12,
                showSubtitle: false,
                hideInactiveLeading: false,
                activeColor: Colors.amber,
                activeStepLineColor: Colors.amber,
                titleActiveColor: Colors.amber,
                leadingSize: 30,
